...
class MonterViewModel(var repository: Repository) : ViewModel() {
    ...
    val monterLiveData: MutableLiveData<List<ClaimData>> = MutableLiveData()

    fun getAllItemsMonter(
        collection0: String, document0: String, subCollection1: String,
        document1: String, subCollection2: String
    ) = viewModelScope.launch {

        monterLiveData.value = repository.getAllItemsMonter(
            collection0 = collection0, document0 = document0,
